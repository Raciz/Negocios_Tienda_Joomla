...
if ($action == 'create' && $user->rights->mylist->creer)
{
	...
	// TitleMenu
	print '<tr><td><span class="fieldrequired">'.$langs->trans("TitleMenu").'</span></td><td><input size="30" type="text" name="titlemenu" value="'.$_POST["titlemenu"].'"></td></tr>';
...
elseif ($action == 'update' && $user->rights->mylist->creer)
{
	...
	// TitleMenu
	print '<tr><td><span class="fieldrequired">'.$langs->trans("TitleMenu").'</span></td><td><input size="30" type="text" name="titlemenu" value="'.$object->titlemenu.'"></td></tr>';
...
else
{
	...
	// Menu
	print '<tr><td>'.$langs->trans("TitleMenu").'</td><td >'.$object->titlemenu.'</td></tr>';
	...
	print '<tr><td>'.$langs->trans("forceall").'</td><td >'.yn($object->forceall).'</td></tr>';
